...
static struct Command commands[] = {
	...
	{ "mon_continue", "Continue normal execution",mon_continue},
	{ "mon_stepi", "Go to next instruction and diving into function",mon_stepi},
	{ "mon_disassembler","To convert machine code to x86",mon_disassembler},
};
