...
umain(int argc, char **argv)
{
  ...
  800055:	c7 04 24 a0 1f 80 00 	movl   $0x801fa0,(%esp)
  80005c:	e8 17 01 00 00       	call   800178 <cprintf>
}
  800061:	c9                   	leave  
  800062:	c3                   	ret    
	...
...
libmain(int argc, char **argv)
{
  ...
  800093:	a3 08 40 80 00       	mov    %eax,0x804008
	// cprintf("%x\n",pthisenv);
	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  800249:	0f be 80 b8 1f 80 00 	movsbl 0x801fb8(%eax),%eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap)
{
  ...
  800364:	ff 24 95 00 21 80 00 	jmp    *0x802100(,%edx,4)
  ...
  800424:	c7 44 24 08 91 23 80 	movl   $0x802391,0x8(%esp)
  80042b:	00 
  ...
  800458:	75 05                	jne    80045f <vprintfmt+0x185>
				p = "(null)";
  80045a:	be c9 1f 80 00       	mov    $0x801fc9,%esi
			if (width > 0 && padc != '-')
...
sys_env_destroy(envid_t envid)
{
  ...
  800ab2:	00 
  800ab3:	c7 44 24 08 bf 22 80 	movl   $0x8022bf,0x8(%esp)
  800aba:	00 
  800abb:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800ac2:	00 
  800ac3:	c7 04 24 dc 22 80 00 	movl   $0x8022dc,(%esp)
...
sys_page_alloc(envid_t envid, void *va, int perm)
{
  ...
  800b44:	00 
  800b45:	c7 44 24 08 bf 22 80 	movl   $0x8022bf,0x8(%esp)
  800b4c:	00 
  800b4d:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800b54:	00 
  800b55:	c7 04 24 dc 22 80 00 	movl   $0x8022dc,(%esp)
...
sys_page_map(envid_t srcenv, void *srcva, envid_t dstenv, void *dstva, int perm)
{
  ...
  800b97:	00 
  800b98:	c7 44 24 08 bf 22 80 	movl   $0x8022bf,0x8(%esp)
  800b9f:	00 
  800ba0:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800ba7:	00 
  800ba8:	c7 04 24 dc 22 80 00 	movl   $0x8022dc,(%esp)
...
sys_page_unmap(envid_t envid, void *va)
{
  ...
  800bea:	00 
  800beb:	c7 44 24 08 bf 22 80 	movl   $0x8022bf,0x8(%esp)
  800bf2:	00 
  800bf3:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800bfa:	00 
  800bfb:	c7 04 24 dc 22 80 00 	movl   $0x8022dc,(%esp)
...
sys_env_set_status(envid_t envid, int status)
{
  ...
  800c3d:	00 
  800c3e:	c7 44 24 08 bf 22 80 	movl   $0x8022bf,0x8(%esp)
  800c45:	00 
  800c46:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800c4d:	00 
  800c4e:	c7 04 24 dc 22 80 00 	movl   $0x8022dc,(%esp)
...
sys_env_set_trapframe(envid_t envid, struct Trapframe *tf)
{
  ...
  800c90:	00 
  800c91:	c7 44 24 08 bf 22 80 	movl   $0x8022bf,0x8(%esp)
  800c98:	00 
  800c99:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800ca0:	00 
  800ca1:	c7 04 24 dc 22 80 00 	movl   $0x8022dc,(%esp)
...
sys_env_set_pgfault_upcall(envid_t envid, void *upcall)
{
  ...
  800ce3:	00 
  800ce4:	c7 44 24 08 bf 22 80 	movl   $0x8022bf,0x8(%esp)
  800ceb:	00 
  800cec:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800cf3:	00 
  800cf4:	c7 04 24 dc 22 80 00 	movl   $0x8022dc,(%esp)
...
sys_ipc_recv(void *dstva)
{
  ...
  800d58:	00 
  800d59:	c7 44 24 08 bf 22 80 	movl   $0x8022bf,0x8(%esp)
  800d60:	00 
  800d61:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800d68:	00 
  800d69:	c7 04 24 dc 22 80 00 	movl   $0x8022dc,(%esp)
...
dev_lookup(int dev_id, struct Dev **dev)
{
	...
	for (i = 0; devtab[i]; i++)
  800e75:	42                   	inc    %edx
  800e76:	8b 04 95 68 23 80 00 	mov    0x802368(,%edx,4),%eax
  ...
  800e81:	a1 08 40 80 00       	mov    0x804008,%eax
  ...
  800e93:	c7 04 24 ec 22 80 00 	movl   $0x8022ec,(%esp)
...
read(int fdnum, void *buf, size_t n)
{
  ...
  8010f1:	c7 04 24 2d 23 80 00 	movl   $0x80232d,(%esp)
...
write(int fdnum, const void *buf, size_t n)
{
  ...
  8011c9:	c7 04 24 49 23 80 00 	movl   $0x802349,(%esp)
...
ftruncate(int fdnum, off_t newsize)
{
  ...
  801282:	c7 04 24 0c 23 80 00 	movl   $0x80230c,(%esp)
...
devfile_write(struct Fd *fd, const void *buf, size_t n)
{
  ...
  8014da:	c7 44 24 0c 78 23 80 	movl   $0x802378,0xc(%esp)
  8014e1:	00 
  8014e2:	c7 44 24 08 7f 23 80 	movl   $0x80237f,0x8(%esp)
  8014e9:	00 
  8014ea:	c7 44 24 04 9b 00 00 	movl   $0x9b,0x4(%esp)
  8014f1:	00 
  8014f2:	c7 04 24 94 23 80 00 	movl   $0x802394,(%esp)
  8014f9:	e8 92 06 00 00       	call   801b90 <_panic>
	assert(r <= PGSIZE);
  8014fe:	3d 00 10 00 00       	cmp    $0x1000,%eax
  801503:	7e 24                	jle    801529 <devfile_write+0xa6>
  801505:	c7 44 24 0c 9f 23 80 	movl   $0x80239f,0xc(%esp)
  80150c:	00 
  80150d:	c7 44 24 08 7f 23 80 	movl   $0x80237f,0x8(%esp)
  801514:	00 
  801515:	c7 44 24 04 9c 00 00 	movl   $0x9c,0x4(%esp)
  80151c:	00 
  80151d:	c7 04 24 94 23 80 00 	movl   $0x802394,(%esp)
...
devfile_read(struct Fd *fd, void *buf, size_t n)
{
  ...
  801564:	c7 44 24 0c 78 23 80 	movl   $0x802378,0xc(%esp)
  80156b:	00 
  80156c:	c7 44 24 08 7f 23 80 	movl   $0x80237f,0x8(%esp)
  801573:	00 
  801574:	c7 44 24 04 7f 00 00 	movl   $0x7f,0x4(%esp)
  80157b:	00 
  80157c:	c7 04 24 94 23 80 00 	movl   $0x802394,(%esp)
  801583:	e8 08 06 00 00       	call   801b90 <_panic>
	assert(r <= PGSIZE);
  801588:	3d 00 10 00 00       	cmp    $0x1000,%eax
  80158d:	7e 24                	jle    8015b3 <devfile_read+0x84>
  80158f:	c7 44 24 0c 9f 23 80 	movl   $0x80239f,0xc(%esp)
  801596:	00 
  801597:	c7 44 24 08 7f 23 80 	movl   $0x80237f,0x8(%esp)
  80159e:	00 
  80159f:	c7 44 24 04 80 00 00 	movl   $0x80,0x4(%esp)
  8015a6:	00 
  8015a7:	c7 04 24 94 23 80 00 	movl   $0x802394,(%esp)
...
devpipe_stat(struct Fd *fd, struct Stat *stat)
{
  ...
  80168c:	c7 44 24 04 ab 23 80 	movl   $0x8023ab,0x4(%esp)
  801693:	00 
...
_pipeisclosed(struct Fd *fd, struct Pipe *p)
{
  ...
  80170a:	89 55 e4             	mov    %edx,-0x1c(%ebp)
	...
	while (1) {
		n = thisenv->env_runs;
  80170d:	a1 08 40 80 00       	mov    0x804008,%eax
  ...
  801731:	0f b6 c0             	movzbl %al,%eax
		nn = thisenv->env_runs;
  801734:	8b 15 08 40 80 00    	mov    0x804008,%edx
  ...
  801763:	c7 04 24 b2 23 80 00 	movl   $0x8023b2,(%esp)
...
devcons_stat(struct Fd *fd, struct Stat *stat)
{
  ...
  801a00:	c7 44 24 04 ca 23 80 	movl   $0x8023ca,0x4(%esp)
  801a07:	00 
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  801bbc:	c7 04 24 d8 23 80 00 	movl   $0x8023d8,(%esp)
  ...
  801bd2:	e8 40 e5 ff ff       	call   800117 <vcprintf>
	cprintf("\n");
  801bd7:	c7 04 24 0c 24 80 00 	movl   $0x80240c,(%esp)
...
ipc_recv(envid_t *from_env_store, void *pg, int *perm_store)
{
  ...
  801c28:	a1 08 40 80 00       	mov    0x804008,%eax
...
ipc_send(envid_t to_env, uint32_t val, void *pg, int perm)
{
  ...
  801c97:	c7 44 24 08 fc 23 80 	movl   $0x8023fc,0x8(%esp)
  801c9e:	00 
  801c9f:	c7 44 24 04 3e 00 00 	movl   $0x3e,0x4(%esp)
  801ca6:	00 
  801ca7:	c7 04 24 0e 24 80 00 	movl   $0x80240e,(%esp)
