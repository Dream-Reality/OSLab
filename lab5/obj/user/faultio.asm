...
read_eflags(void)
{
  ...
  800041:	c7 04 24 a0 1f 80 00 	movl   $0x801fa0,(%esp)
  800048:	e8 2b 01 00 00       	call   800178 <cprintf>
}
...
outb(int port, uint8_t data)
{
  ...
  800055:	c7 04 24 ae 1f 80 00 	movl   $0x801fae,(%esp)
	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  800249:	0f be 80 d2 1f 80 00 	movsbl 0x801fd2(%eax),%eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap)
{
  ...
  800401:	c7 44 24 08 ea 1f 80 	movl   $0x801fea,0x8(%esp)
  800408:	00 
  ...
  800458:	75 05                	jne    80045f <vprintfmt+0x185>
				p = "(null)";
  80045a:	be e3 1f 80 00       	mov    $0x801fe3,%esi
			if (width > 0 && padc != '-')
