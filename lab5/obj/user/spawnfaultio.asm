...
umain(int argc, char **argv)
{
  ...
  800078:	c7 44 24 08 46 26 80 	movl   $0x802646,0x8(%esp)
  80007f:	00 
  800080:	c7 44 24 04 09 00 00 	movl   $0x9,0x4(%esp)
  800087:	00 
  800088:	c7 04 24 60 26 80 00 	movl   $0x802660,(%esp)
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  800138:	c7 04 24 80 26 80 00 	movl   $0x802680,(%esp)
	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  8002d5:	0f be 80 a3 26 80 00 	movsbl 0x8026a3(%eax),%eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap)
{
  ...
  80048d:	c7 44 24 08 bb 26 80 	movl   $0x8026bb,0x8(%esp)
  800494:	00 
  ...
  8004e4:	75 05                	jne    8004eb <vprintfmt+0x185>
				p = "(null)";
  8004e6:	be b4 26 80 00       	mov    $0x8026b4,%esi
			if (width > 0 && padc != '-')
