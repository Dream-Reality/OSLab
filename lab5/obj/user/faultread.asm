	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  800239:	0f be 80 c8 1f 80 00 	movsbl 0x801fc8(%eax),%eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap)
{
  ...
  800354:	ff 24 95 00 21 80 00 	jmp    *0x802100(,%edx,4)
  ...
  800414:	c7 44 24 08 91 23 80 	movl   $0x802391,0x8(%esp)
  80041b:	00 
  ...
  800448:	75 05                	jne    80044f <vprintfmt+0x185>
				p = "(null)";
  80044a:	be d9 1f 80 00       	mov    $0x801fd9,%esi
			if (width > 0 && padc != '-')
...
sys_env_destroy(envid_t envid)
{
  ...
  800aa2:	00 
  800aa3:	c7 44 24 08 bf 22 80 	movl   $0x8022bf,0x8(%esp)
  800aaa:	00 
  800aab:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800ab2:	00 
  800ab3:	c7 04 24 dc 22 80 00 	movl   $0x8022dc,(%esp)
...
sys_page_alloc(envid_t envid, void *va, int perm)
{
  ...
  800b34:	00 
  800b35:	c7 44 24 08 bf 22 80 	movl   $0x8022bf,0x8(%esp)
  800b3c:	00 
  800b3d:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800b44:	00 
  800b45:	c7 04 24 dc 22 80 00 	movl   $0x8022dc,(%esp)
...
sys_page_map(envid_t srcenv, void *srcva, envid_t dstenv, void *dstva, int perm)
{
  ...
  800b87:	00 
  800b88:	c7 44 24 08 bf 22 80 	movl   $0x8022bf,0x8(%esp)
  800b8f:	00 
  800b90:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800b97:	00 
  800b98:	c7 04 24 dc 22 80 00 	movl   $0x8022dc,(%esp)
...
sys_page_unmap(envid_t envid, void *va)
{
  ...
  800bda:	00 
  800bdb:	c7 44 24 08 bf 22 80 	movl   $0x8022bf,0x8(%esp)
  800be2:	00 
  800be3:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800bea:	00 
  800beb:	c7 04 24 dc 22 80 00 	movl   $0x8022dc,(%esp)
...
sys_env_set_status(envid_t envid, int status)
{
  ...
  800c2d:	00 
  800c2e:	c7 44 24 08 bf 22 80 	movl   $0x8022bf,0x8(%esp)
  800c35:	00 
  800c36:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800c3d:	00 
  800c3e:	c7 04 24 dc 22 80 00 	movl   $0x8022dc,(%esp)
...
sys_env_set_trapframe(envid_t envid, struct Trapframe *tf)
{
  ...
  800c80:	00 
  800c81:	c7 44 24 08 bf 22 80 	movl   $0x8022bf,0x8(%esp)
  800c88:	00 
  800c89:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800c90:	00 
  800c91:	c7 04 24 dc 22 80 00 	movl   $0x8022dc,(%esp)
...
sys_env_set_pgfault_upcall(envid_t envid, void *upcall)
{
  ...
  800cd3:	00 
  800cd4:	c7 44 24 08 bf 22 80 	movl   $0x8022bf,0x8(%esp)
  800cdb:	00 
  800cdc:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800ce3:	00 
  800ce4:	c7 04 24 dc 22 80 00 	movl   $0x8022dc,(%esp)
...
sys_ipc_recv(void *dstva)
{
  ...
  800d48:	00 
  800d49:	c7 44 24 08 bf 22 80 	movl   $0x8022bf,0x8(%esp)
  800d50:	00 
  800d51:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800d58:	00 
  800d59:	c7 04 24 dc 22 80 00 	movl   $0x8022dc,(%esp)
...
dev_lookup(int dev_id, struct Dev **dev)
{
	...
	for (i = 0; devtab[i]; i++)
  800e65:	42                   	inc    %edx
  800e66:	8b 04 95 68 23 80 00 	mov    0x802368(,%edx,4),%eax
  ...
  800e83:	c7 04 24 ec 22 80 00 	movl   $0x8022ec,(%esp)
...
read(int fdnum, void *buf, size_t n)
{
  ...
  8010e1:	c7 04 24 2d 23 80 00 	movl   $0x80232d,(%esp)
...
write(int fdnum, const void *buf, size_t n)
{
  ...
  8011b9:	c7 04 24 49 23 80 00 	movl   $0x802349,(%esp)
...
ftruncate(int fdnum, off_t newsize)
{
  ...
  801272:	c7 04 24 0c 23 80 00 	movl   $0x80230c,(%esp)
...
devfile_write(struct Fd *fd, const void *buf, size_t n)
{
  ...
  8014ca:	c7 44 24 0c 78 23 80 	movl   $0x802378,0xc(%esp)
  8014d1:	00 
  8014d2:	c7 44 24 08 7f 23 80 	movl   $0x80237f,0x8(%esp)
  8014d9:	00 
  8014da:	c7 44 24 04 9b 00 00 	movl   $0x9b,0x4(%esp)
  8014e1:	00 
  8014e2:	c7 04 24 94 23 80 00 	movl   $0x802394,(%esp)
  8014e9:	e8 92 06 00 00       	call   801b80 <_panic>
	assert(r <= PGSIZE);
  8014ee:	3d 00 10 00 00       	cmp    $0x1000,%eax
  8014f3:	7e 24                	jle    801519 <devfile_write+0xa6>
  8014f5:	c7 44 24 0c 9f 23 80 	movl   $0x80239f,0xc(%esp)
  8014fc:	00 
  8014fd:	c7 44 24 08 7f 23 80 	movl   $0x80237f,0x8(%esp)
  801504:	00 
  801505:	c7 44 24 04 9c 00 00 	movl   $0x9c,0x4(%esp)
  80150c:	00 
  80150d:	c7 04 24 94 23 80 00 	movl   $0x802394,(%esp)
...
devfile_read(struct Fd *fd, void *buf, size_t n)
{
  ...
  801554:	c7 44 24 0c 78 23 80 	movl   $0x802378,0xc(%esp)
  80155b:	00 
  80155c:	c7 44 24 08 7f 23 80 	movl   $0x80237f,0x8(%esp)
  801563:	00 
  801564:	c7 44 24 04 7f 00 00 	movl   $0x7f,0x4(%esp)
  80156b:	00 
  80156c:	c7 04 24 94 23 80 00 	movl   $0x802394,(%esp)
  801573:	e8 08 06 00 00       	call   801b80 <_panic>
	assert(r <= PGSIZE);
  801578:	3d 00 10 00 00       	cmp    $0x1000,%eax
  80157d:	7e 24                	jle    8015a3 <devfile_read+0x84>
  80157f:	c7 44 24 0c 9f 23 80 	movl   $0x80239f,0xc(%esp)
  801586:	00 
  801587:	c7 44 24 08 7f 23 80 	movl   $0x80237f,0x8(%esp)
  80158e:	00 
  80158f:	c7 44 24 04 80 00 00 	movl   $0x80,0x4(%esp)
  801596:	00 
  801597:	c7 04 24 94 23 80 00 	movl   $0x802394,(%esp)
...
devpipe_stat(struct Fd *fd, struct Stat *stat)
{
  ...
  80167c:	c7 44 24 04 ab 23 80 	movl   $0x8023ab,0x4(%esp)
  801683:	00 
...
_pipeisclosed(struct Fd *fd, struct Pipe *p)
{
  ...
  801753:	c7 04 24 b2 23 80 00 	movl   $0x8023b2,(%esp)
...
devcons_stat(struct Fd *fd, struct Stat *stat)
{
  ...
  8019f0:	c7 44 24 04 ca 23 80 	movl   $0x8023ca,0x4(%esp)
  8019f7:	00 
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  801bac:	c7 04 24 d8 23 80 00 	movl   $0x8023d8,(%esp)
  ...
  801bc2:	e8 40 e5 ff ff       	call   800107 <vcprintf>
	cprintf("\n");
  801bc7:	c7 04 24 bc 1f 80 00 	movl   $0x801fbc,(%esp)
...
ipc_send(envid_t to_env, uint32_t val, void *pg, int perm)
{
  ...
  801c87:	c7 44 24 08 fc 23 80 	movl   $0x8023fc,0x8(%esp)
  801c8e:	00 
  801c8f:	c7 44 24 04 3e 00 00 	movl   $0x3e,0x4(%esp)
  801c96:	00 
  801c97:	c7 04 24 0e 24 80 00 	movl   $0x80240e,(%esp)
