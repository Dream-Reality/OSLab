...
umain(int argc, char **argv)
{
  ...
  800041:	0f 80 00 
	...
	while (1) {
		sys_yield();
  800044:	e8 9d 0a 00 00       	call   800ae6 <sys_yield>
...
libmain(int argc, char **argv)
{
  ...
  80005a:	e8 68 0a 00 00       	call   800ac7 <sys_getenvid>
  ...
  800080:	89 44 24 04          	mov    %eax,0x4(%esp)
	cprintf("%x\n",pthisenv);
  800084:	c7 04 24 e5 0f 80 00 	movl   $0x800fe5,(%esp)
  80008b:	e8 d8 00 00 00       	call   800168 <cprintf>
	// save the name of the program so that panic() can use it
	if (argc > 0)
  800090:	85 f6                	test   %esi,%esi
  800092:	7e 07                	jle    80009b <libmain+0x4f>
		binaryname = argv[0];
	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  800239:	0f be 80 f3 0f 80 00 	movsbl 0x800ff3(%eax),%eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap)
{
  ...
  800354:	ff 24 95 c0 10 80 00 	jmp    *0x8010c0(,%edx,4)
  ...
  800414:	c7 44 24 08 14 10 80 	movl   $0x801014,0x8(%esp)
  80041b:	00 
  ...
  800448:	75 05                	jne    80044f <vprintfmt+0x185>
				p = "(null)";
  80044a:	be 04 10 80 00       	mov    $0x801004,%esi
			if (width > 0 && padc != '-')
...
sys_env_destroy(envid_t envid)
{
  ...
  800aa2:	00 
  800aa3:	c7 44 24 08 44 12 80 	movl   $0x801244,0x8(%esp)
  800aaa:	00 
  800aab:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800ab2:	00 
  800ab3:	c7 04 24 61 12 80 00 	movl   $0x801261,(%esp)
...
sys_page_alloc(envid_t envid, void *va, int perm)
{
  ...
  800b34:	00 
  800b35:	c7 44 24 08 44 12 80 	movl   $0x801244,0x8(%esp)
  800b3c:	00 
  800b3d:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800b44:	00 
  800b45:	c7 04 24 61 12 80 00 	movl   $0x801261,(%esp)
...
sys_page_map(envid_t srcenv, void *srcva, envid_t dstenv, void *dstva, int perm)
{
  ...
  800b87:	00 
  800b88:	c7 44 24 08 44 12 80 	movl   $0x801244,0x8(%esp)
  800b8f:	00 
  800b90:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800b97:	00 
  800b98:	c7 04 24 61 12 80 00 	movl   $0x801261,(%esp)
...
sys_page_unmap(envid_t envid, void *va)
{
  ...
  800bda:	00 
  800bdb:	c7 44 24 08 44 12 80 	movl   $0x801244,0x8(%esp)
  800be2:	00 
  800be3:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800bea:	00 
  800beb:	c7 04 24 61 12 80 00 	movl   $0x801261,(%esp)
...
sys_env_set_status(envid_t envid, int status)
{
  ...
  800c2d:	00 
  800c2e:	c7 44 24 08 44 12 80 	movl   $0x801244,0x8(%esp)
  800c35:	00 
  800c36:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800c3d:	00 
  800c3e:	c7 04 24 61 12 80 00 	movl   $0x801261,(%esp)
...
sys_env_set_pgfault_upcall(envid_t envid, void *upcall)
{
  ...
  800c80:	00 
  800c81:	c7 44 24 08 44 12 80 	movl   $0x801244,0x8(%esp)
  800c88:	00 
  800c89:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800c90:	00 
  800c91:	c7 04 24 61 12 80 00 	movl   $0x801261,(%esp)
...
sys_ipc_recv(void *dstva)
{
  ...
  800cf5:	00 
  800cf6:	c7 44 24 08 44 12 80 	movl   $0x801244,0x8(%esp)
  800cfd:	00 
  800cfe:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800d05:	00 
  800d06:	c7 04 24 61 12 80 00 	movl   $0x801261,(%esp)
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  800d48:	c7 04 24 70 12 80 00 	movl   $0x801270,(%esp)
  ...
  800d5e:	e8 a4 f3 ff ff       	call   800107 <vcprintf>
	cprintf("\n");
  800d63:	c7 04 24 e7 0f 80 00 	movl   $0x800fe7,(%esp)
