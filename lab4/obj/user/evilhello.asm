...
umain(int argc, char **argv)
{
  ...
  800049:	e8 ee 09 00 00       	call   800a3c <sys_cputs>
}
  80004e:	c9                   	leave  
  80004f:	c3                   	ret    
...
libmain(int argc, char **argv)
{
  ...
  80005e:	e8 68 0a 00 00       	call   800acb <sys_getenvid>
  ...
  800084:	89 44 24 04          	mov    %eax,0x4(%esp)
	cprintf("%x\n",pthisenv);
  800088:	c7 04 24 e0 0f 80 00 	movl   $0x800fe0,(%esp)
  80008f:	e8 d8 00 00 00       	call   80016c <cprintf>
	// save the name of the program so that panic() can use it
	if (argc > 0)
  800094:	85 f6                	test   %esi,%esi
  800096:	7e 07                	jle    80009f <libmain+0x4f>
		binaryname = argv[0];
	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  80023d:	0f be 80 ee 0f 80 00 	movsbl 0x800fee(%eax),%eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap)
{
  ...
  8003f5:	c7 44 24 08 06 10 80 	movl   $0x801006,0x8(%esp)
  8003fc:	00 
  ...
  800418:	c7 44 24 08 0f 10 80 	movl   $0x80100f,0x8(%esp)
  80041f:	00 
  ...
  80044c:	75 05                	jne    800453 <vprintfmt+0x185>
				p = "(null)";
  80044e:	be ff 0f 80 00       	mov    $0x800fff,%esi
			if (width > 0 && padc != '-')
...
sys_env_destroy(envid_t envid)
{
  ...
  800aa6:	00 
  800aa7:	c7 44 24 08 44 12 80 	movl   $0x801244,0x8(%esp)
  800aae:	00 
  800aaf:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800ab6:	00 
  800ab7:	c7 04 24 61 12 80 00 	movl   $0x801261,(%esp)
...
sys_page_alloc(envid_t envid, void *va, int perm)
{
  ...
  800b38:	00 
  800b39:	c7 44 24 08 44 12 80 	movl   $0x801244,0x8(%esp)
  800b40:	00 
  800b41:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800b48:	00 
  800b49:	c7 04 24 61 12 80 00 	movl   $0x801261,(%esp)
...
sys_page_map(envid_t srcenv, void *srcva, envid_t dstenv, void *dstva, int perm)
{
  ...
  800b8b:	00 
  800b8c:	c7 44 24 08 44 12 80 	movl   $0x801244,0x8(%esp)
  800b93:	00 
  800b94:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800b9b:	00 
  800b9c:	c7 04 24 61 12 80 00 	movl   $0x801261,(%esp)
...
sys_page_unmap(envid_t envid, void *va)
{
  ...
  800bde:	00 
  800bdf:	c7 44 24 08 44 12 80 	movl   $0x801244,0x8(%esp)
  800be6:	00 
  800be7:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800bee:	00 
  800bef:	c7 04 24 61 12 80 00 	movl   $0x801261,(%esp)
...
sys_env_set_status(envid_t envid, int status)
{
  ...
  800c31:	00 
  800c32:	c7 44 24 08 44 12 80 	movl   $0x801244,0x8(%esp)
  800c39:	00 
  800c3a:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800c41:	00 
  800c42:	c7 04 24 61 12 80 00 	movl   $0x801261,(%esp)
...
sys_env_set_pgfault_upcall(envid_t envid, void *upcall)
{
  ...
  800c84:	00 
  800c85:	c7 44 24 08 44 12 80 	movl   $0x801244,0x8(%esp)
  800c8c:	00 
  800c8d:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800c94:	00 
  800c95:	c7 04 24 61 12 80 00 	movl   $0x801261,(%esp)
...
sys_ipc_recv(void *dstva)
{
  ...
  800cf9:	00 
  800cfa:	c7 44 24 08 44 12 80 	movl   $0x801244,0x8(%esp)
  800d01:	00 
  800d02:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800d09:	00 
  800d0a:	c7 04 24 61 12 80 00 	movl   $0x801261,(%esp)
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  800d4c:	c7 04 24 70 12 80 00 	movl   $0x801270,(%esp)
  ...
  800d62:	e8 a4 f3 ff ff       	call   80010b <vcprintf>
	cprintf("\n");
  800d67:	c7 04 24 e2 0f 80 00 	movl   $0x800fe2,(%esp)
