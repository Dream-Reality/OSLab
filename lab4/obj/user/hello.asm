...
umain(int argc, char **argv)
{
  ...
  800041:	e8 3a 01 00 00       	call   800180 <cprintf>
  ...
  800054:	c7 04 24 ee 0f 80 00 	movl   $0x800fee,(%esp)
  80005b:	e8 20 01 00 00       	call   800180 <cprintf>
}
  800060:	c9                   	leave  
  800061:	c3                   	ret    
	...
...
libmain(int argc, char **argv)
{
  ...
  800093:	a3 04 20 80 00       	mov    %eax,0x802004
  800098:	89 44 24 04          	mov    %eax,0x4(%esp)
	cprintf("%x\n",pthisenv);
  80009c:	c7 04 24 05 10 80 00 	movl   $0x801005,(%esp)
	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  800251:	0f be 80 13 10 80 00 	movsbl 0x801013(%eax),%eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap)
{
  ...
  80036c:	ff 24 95 e0 10 80 00 	jmp    *0x8010e0(,%edx,4)
  ...
  80042c:	c7 44 24 08 34 10 80 	movl   $0x801034,0x8(%esp)
  800433:	00 
  ...
  800460:	75 05                	jne    800467 <vprintfmt+0x185>
				p = "(null)";
  800462:	be 24 10 80 00       	mov    $0x801024,%esi
			if (width > 0 && padc != '-')
...
sys_env_destroy(envid_t envid)
{
  ...
  800aba:	00 
  800abb:	c7 44 24 08 64 12 80 	movl   $0x801264,0x8(%esp)
  800ac2:	00 
  800ac3:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800aca:	00 
  800acb:	c7 04 24 81 12 80 00 	movl   $0x801281,(%esp)
...
sys_page_alloc(envid_t envid, void *va, int perm)
{
  ...
  800b4c:	00 
  800b4d:	c7 44 24 08 64 12 80 	movl   $0x801264,0x8(%esp)
  800b54:	00 
  800b55:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800b5c:	00 
  800b5d:	c7 04 24 81 12 80 00 	movl   $0x801281,(%esp)
...
sys_page_map(envid_t srcenv, void *srcva, envid_t dstenv, void *dstva, int perm)
{
  ...
  800b9f:	00 
  800ba0:	c7 44 24 08 64 12 80 	movl   $0x801264,0x8(%esp)
  800ba7:	00 
  800ba8:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800baf:	00 
  800bb0:	c7 04 24 81 12 80 00 	movl   $0x801281,(%esp)
...
sys_page_unmap(envid_t envid, void *va)
{
  ...
  800bf2:	00 
  800bf3:	c7 44 24 08 64 12 80 	movl   $0x801264,0x8(%esp)
  800bfa:	00 
  800bfb:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800c02:	00 
  800c03:	c7 04 24 81 12 80 00 	movl   $0x801281,(%esp)
...
sys_env_set_status(envid_t envid, int status)
{
  ...
  800c45:	00 
  800c46:	c7 44 24 08 64 12 80 	movl   $0x801264,0x8(%esp)
  800c4d:	00 
  800c4e:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800c55:	00 
  800c56:	c7 04 24 81 12 80 00 	movl   $0x801281,(%esp)
...
sys_env_set_pgfault_upcall(envid_t envid, void *upcall)
{
  ...
  800c98:	00 
  800c99:	c7 44 24 08 64 12 80 	movl   $0x801264,0x8(%esp)
  800ca0:	00 
  800ca1:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800ca8:	00 
  800ca9:	c7 04 24 81 12 80 00 	movl   $0x801281,(%esp)
...
sys_ipc_recv(void *dstva)
{
  ...
  800d0d:	00 
  800d0e:	c7 44 24 08 64 12 80 	movl   $0x801264,0x8(%esp)
  800d15:	00 
  800d16:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800d1d:	00 
  800d1e:	c7 04 24 81 12 80 00 	movl   $0x801281,(%esp)
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  800d60:	c7 04 24 90 12 80 00 	movl   $0x801290,(%esp)
