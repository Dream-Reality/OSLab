...
umain(int argc, char **argv)
{
  ...
  8000da:	e8 49 0a 00 00       	call   800b28 <sys_cputs>
}
  8000df:	c9                   	leave  
  8000e0:	c3                   	ret    
...
libmain(int argc, char **argv)
{
  ...
  8000f2:	e8 c0 0a 00 00       	call   800bb7 <sys_getenvid>
  ...
  800118:	89 44 24 04          	mov    %eax,0x4(%esp)
	cprintf("%x\n",pthisenv);
  80011c:	c7 04 24 26 11 80 00 	movl   $0x801126,(%esp)
  800123:	e8 30 01 00 00       	call   800258 <cprintf>
	// save the name of the program so that panic() can use it
	if (argc > 0)
  800128:	85 f6                	test   %esi,%esi
  80012a:	7e 07                	jle    800133 <libmain+0x4f>
		binaryname = argv[0];
  ...
  80013a:	e8 7a ff ff ff       	call   8000b9 <umain>
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  8001a2:	e8 50 00 00 00       	call   8001f7 <vcprintf>
	cprintf("\n");
  8001a7:	c7 04 24 28 11 80 00 	movl   $0x801128,(%esp)
	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  8002cd:	e8 f2 0b 00 00       	call   800ec4 <__udivdi3>
  ...
  800320:	e8 bf 0c 00 00       	call   800fe4 <__umoddi3>
...
sys_env_destroy(envid_t envid)
{
  ...
  800b92:	00 
  800b93:	c7 44 24 08 04 14 80 	movl   $0x801404,0x8(%esp)
  800b9a:	00 
  800b9b:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800ba2:	00 
  800ba3:	c7 04 24 21 14 80 00 	movl   $0x801421,(%esp)
...
sys_page_alloc(envid_t envid, void *va, int perm)
{
  ...
  800c24:	00 
  800c25:	c7 44 24 08 04 14 80 	movl   $0x801404,0x8(%esp)
  800c2c:	00 
  800c2d:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800c34:	00 
  800c35:	c7 04 24 21 14 80 00 	movl   $0x801421,(%esp)
...
sys_page_map(envid_t srcenv, void *srcva, envid_t dstenv, void *dstva, int perm)
{
  ...
  800c77:	00 
  800c78:	c7 44 24 08 04 14 80 	movl   $0x801404,0x8(%esp)
  800c7f:	00 
  800c80:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800c87:	00 
  800c88:	c7 04 24 21 14 80 00 	movl   $0x801421,(%esp)
...
sys_page_unmap(envid_t envid, void *va)
{
  ...
  800cca:	00 
  800ccb:	c7 44 24 08 04 14 80 	movl   $0x801404,0x8(%esp)
  800cd2:	00 
  800cd3:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800cda:	00 
  800cdb:	c7 04 24 21 14 80 00 	movl   $0x801421,(%esp)
...
sys_env_set_status(envid_t envid, int status)
{
  ...
  800d1d:	00 
  800d1e:	c7 44 24 08 04 14 80 	movl   $0x801404,0x8(%esp)
  800d25:	00 
  800d26:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800d2d:	00 
  800d2e:	c7 04 24 21 14 80 00 	movl   $0x801421,(%esp)
...
sys_env_set_pgfault_upcall(envid_t envid, void *upcall)
{
  ...
  800d70:	00 
  800d71:	c7 44 24 08 04 14 80 	movl   $0x801404,0x8(%esp)
  800d78:	00 
  800d79:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800d80:	00 
  800d81:	c7 04 24 21 14 80 00 	movl   $0x801421,(%esp)
...
sys_ipc_recv(void *dstva)
{
  ...
  800de5:	00 
  800de6:	c7 44 24 08 04 14 80 	movl   $0x801404,0x8(%esp)
  800ded:	00 
  800dee:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800df5:	00 
  800df6:	c7 04 24 21 14 80 00 	movl   $0x801421,(%esp)
...
set_pgfault_handler(void (*handler)(struct UTrapframe *utf))
{
  ...
  800e0f:	53                   	push   %ebx
  800e10:	83 ec 14             	sub    $0x14,%esp
	int r;

	if (_pgfault_handler == 0) {
  800e13:	83 3d 08 20 80 00 00 	cmpl   $0x0,0x802008
  800e1a:	75 6f                	jne    800e8b <set_pgfault_handler+0x7f>
		// First time through!
		// LAB 4: Your code here.
		// cprintf("%x\n",handler);
		envid_t eid = sys_getenvid();
  800e1c:	e8 96 fd ff ff       	call   800bb7 <sys_getenvid>
  ...
  800e3d:	79 1c                	jns    800e5b <set_pgfault_handler+0x4f>
  800e3f:	c7 44 24 08 30 14 80 	movl   $0x801430,0x8(%esp)
  800e46:	00 
  800e47:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800e4e:	00 
  800e4f:	c7 04 24 8c 14 80 00 	movl   $0x80148c,(%esp)
  800e56:	e8 05 f3 ff ff       	call   800160 <_panic>
		r = sys_env_set_pgfault_upcall(eid,_pgfault_upcall);
  800e5b:	c7 44 24 04 9c 0e 80 	movl   $0x800e9c,0x4(%esp)
  800e62:	00 
  800e63:	89 1c 24             	mov    %ebx,(%esp)
  800e66:	e8 d7 fe ff ff       	call   800d42 <sys_env_set_pgfault_upcall>
		if (r<0)panic("set_pgfault_handler: sys_env_set_pgfault_upcall\n");
  800e6b:	85 c0                	test   %eax,%eax
  800e6d:	79 1c                	jns    800e8b <set_pgfault_handler+0x7f>
  800e6f:	c7 44 24 08 58 14 80 	movl   $0x801458,0x8(%esp)
  800e76:	00 
  800e77:	c7 44 24 04 25 00 00 	movl   $0x25,0x4(%esp)
  800e7e:	00 
  800e7f:	c7 04 24 8c 14 80 00 	movl   $0x80148c,(%esp)
  800e86:	e8 d5 f2 ff ff       	call   800160 <_panic>
	}
...
_pgfault_upcall:
  ...
  800ea4:	83 c4 04             	add    $0x4,%esp
	...
	// LAB 4: Your code here.
	movl 0x28(%esp),%eax
  800ea7:	8b 44 24 28          	mov    0x28(%esp),%eax
	subl $0x4, 0x30(%esp)
  800eab:	83 6c 24 30 04       	subl   $0x4,0x30(%esp)
	movl 0x30(%esp), %ebx
  800eb0:	8b 5c 24 30          	mov    0x30(%esp),%ebx
	movl %eax, (%ebx)
  800eb4:	89 03                	mov    %eax,(%ebx)
	addl $8,%esp
...
__udivdi3 (UDWtype n, UDWtype d)
{
  ...
  800ece:	8b 4c 24 28          	mov    0x28(%esp),%ecx
...
__udivmoddi4 (UDWtype n, UDWtype d, UDWtype *rp)
{
  ...
  800ed6:	8b 7c 24 24          	mov    0x24(%esp),%edi
  const DWunion dd = {.ll = d};
  800eda:	89 cd                	mov    %ecx,%ebp
  800edc:	8b 44 24 2c          	mov    0x2c(%esp),%eax
  d1 = dd.s.high;
  n0 = nn.s.low;
  n1 = nn.s.high;
  ...
  800ee2:	75 2c                	jne    800f10 <__udivdi3+0x4c>
    {
      if (d0 > n1)
  800ee4:	39 f9                	cmp    %edi,%ecx
  800ee6:	77 68                	ja     800f50 <__udivdi3+0x8c>
	}
      else
	{
	  /* qq = NN / 0d */
  ...
  800eea:	75 0b                	jne    800ef7 <__udivdi3+0x33>
...
__udivdi3 (UDWtype n, UDWtype d)
{
  ...
  800f0f:	c3                   	ret    
    ...
    {
      if (d1 > n1)
  800f10:	39 f8                	cmp    %edi,%eax
  800f12:	77 2c                	ja     800f40 <__udivdi3+0x7c>
	}
      else
	{
	  /* 0q = NN / dd */
  ...
  800f14:	0f bd f0             	bsr    %eax,%esi
	  if (bm == 0)
  800f17:	83 f6 1f             	xor    $0x1f,%esi
  800f1a:	75 4c                	jne    800f68 <__udivdi3+0xa4>
  ...
  800f1e:	bf 00 00 00 00       	mov    $0x0,%edi
		 ...
		 n1 >= d1 (true due to program flow).  */
	      if (n1 > d1 || n0 >= d0)
  800f23:	72 0a                	jb     800f2f <__udivdi3+0x6b>
  800f25:	3b 4c 24 04          	cmp    0x4(%esp),%ecx
  800f29:	0f 87 ad 00 00 00    	ja     800fdc <__udivdi3+0x118>
		{
		  q0 = 1;
		  sub_ddmmss (n1, n0, n1, n0, d1, d0);
  800f2f:	be 01 00 00 00       	mov    $0x1,%esi
		}
	    }
	}
    }
...
__udivdi3 (UDWtype n, UDWtype d)
{
  ...
  800f6c:	89 44 24 0c          	mov    %eax,0xc(%esp)
	  else
	    {
	      ...
	      b = W_TYPE_SIZE - bm;
  800f70:	b8 20 00 00 00       	mov    $0x20,%eax
  800f75:	29 f0                	sub    %esi,%eax

	      d1 = (d1 << bm) | (d0 >> b);
  800f77:	89 ea                	mov    %ebp,%edx
  800f79:	88 c1                	mov    %al,%cl
  800f7b:	d3 ea                	shr    %cl,%edx
  800f7d:	8b 4c 24 0c          	mov    0xc(%esp),%ecx
  800f81:	09 ca                	or     %ecx,%edx
  800f83:	89 54 24 08          	mov    %edx,0x8(%esp)
	      d0 = d0 << bm;
  800f87:	89 f1                	mov    %esi,%ecx
  800f89:	d3 e5                	shl    %cl,%ebp
  800f8b:	89 6c 24 0c          	mov    %ebp,0xc(%esp)
	      n2 = n1 >> b;
  800f8f:	89 fd                	mov    %edi,%ebp
  800f91:	88 c1                	mov    %al,%cl
  800f93:	d3 ed                	shr    %cl,%ebp
	      n1 = (n1 << bm) | (n0 >> b);
  800f95:	89 fa                	mov    %edi,%edx
  800f97:	89 f1                	mov    %esi,%ecx
  800f99:	d3 e2                	shl    %cl,%edx
  800f9b:	8b 7c 24 04          	mov    0x4(%esp),%edi
  800f9f:	88 c1                	mov    %al,%cl
  800fa1:	d3 ef                	shr    %cl,%edi
  800fa3:	09 d7                	or     %edx,%edi
	      n0 = n0 << bm;

	      udiv_qrnnd (q0, n1, n2, n1, d1);
  800fa5:	89 f8                	mov    %edi,%eax
  800fa7:	89 ea                	mov    %ebp,%edx
  800fa9:	f7 74 24 08          	divl   0x8(%esp)
  800fad:	89 d1                	mov    %edx,%ecx
  800faf:	89 c7                	mov    %eax,%edi
	      umul_ppmm (m1, m0, q0, d0);
  800fb1:	f7 64 24 0c          	mull   0xc(%esp)

	      if (m1 > n1 || (m1 == n1 && m0 > n0))
  800fb5:	39 d1                	cmp    %edx,%ecx
  800fb7:	72 17                	jb     800fd0 <__udivdi3+0x10c>
  800fb9:	74 09                	je     800fc4 <__udivdi3+0x100>
  800fbb:	89 fe                	mov    %edi,%esi
  800fbd:	31 ff                	xor    %edi,%edi
  800fbf:	e9 41 ff ff ff       	jmp    800f05 <__udivdi3+0x41>
	      ...
	      n1 = (n1 << bm) | (n0 >> b);
	      n0 = n0 << bm;
  800fc4:	8b 54 24 04          	mov    0x4(%esp),%edx
  ...
  800fce:	73 eb                	jae    800fbb <__udivdi3+0xf7>
		{
		  q0--;
  800fd0:	8d 77 ff             	lea    -0x1(%edi),%esi
		  sub_ddmmss (m1, m0, m1, m0, d1, d0);
  800fd3:	31 ff                	xor    %edi,%edi
  800fd5:	e9 2b ff ff ff       	jmp    800f05 <__udivdi3+0x41>
  800fda:	66 90                	xchg   %ax,%ax
		 ...
		 n1 >= d1 (true due to program flow).  */
	      if (n1 > d1 || n0 >= d0)
  800fdc:	31 f6                	xor    %esi,%esi
  800fde:	e9 22 ff ff ff       	jmp    800f05 <__udivdi3+0x41>
	...
...
__umoddi3 (UDWtype u, UDWtype v)
{
  ...
  800fea:	8b 44 24 30          	mov    0x30(%esp),%eax
  800fee:	8b 4c 24 38          	mov    0x38(%esp),%ecx
static inline __attribute__ ((__always_inline__))
#endif
UDWtype
__udivmoddi4 (UDWtype n, UDWtype d, UDWtype *rp)
{
  const DWunion nn = {.ll = n};
  800ff2:	89 44 24 14          	mov    %eax,0x14(%esp)
  800ff6:	8b 74 24 34          	mov    0x34(%esp),%esi
  const DWunion dd = {.ll = d};
  800ffa:	89 4c 24 0c          	mov    %ecx,0xc(%esp)
  800ffe:	8b 6c 24 3c          	mov    0x3c(%esp),%ebp
  UWtype q0, q1;
  UWtype b, bm;
...
#if !UDIV_NEEDS_NORMALIZATION
  if (d1 == 0)
  801006:	85 ed                	test   %ebp,%ebp
  801008:	75 16                	jne    801020 <__umoddi3+0x3c>
    {
      if (d0 > n1)
  80100a:	39 f1                	cmp    %esi,%ecx
  80100c:	0f 86 a6 00 00 00    	jbe    8010b8 <__umoddi3+0xd4>
  ...
  80101f:	90                   	nop
    ...
    {
      if (d1 > n1)
  801020:	39 f5                	cmp    %esi,%ebp
  801022:	0f 87 ac 00 00 00    	ja     8010d4 <__umoddi3+0xf0>
	}
      else
	{
	  /* 0q = NN / dd */
	  ...
	  count_leading_zeros (bm, d1);
  801028:	0f bd c5             	bsr    %ebp,%eax
	  if (bm == 0)
  80102b:	83 f0 1f             	xor    $0x1f,%eax
  80102e:	89 44 24 10          	mov    %eax,0x10(%esp)
  801032:	0f 84 a8 00 00 00    	je     8010e0 <__umoddi3+0xfc>
	      UWtype m1, m0;
	      /* Normalize.  */
	      ...
	      d1 = (d1 << bm) | (d0 >> b);
  801038:	8a 4c 24 10          	mov    0x10(%esp),%cl
  80103c:	d3 e5                	shl    %cl,%ebp
	  else
	    {
	      UWtype m1, m0;
	      /* Normalize.  */
	      ...
	      b = W_TYPE_SIZE - bm;
  80103e:	bf 20 00 00 00       	mov    $0x20,%edi
  801043:	2b 7c 24 10          	sub    0x10(%esp),%edi

	      d1 = (d1 << bm) | (d0 >> b);
  801047:	8b 44 24 0c          	mov    0xc(%esp),%eax
  80104b:	89 f9                	mov    %edi,%ecx
  80104d:	d3 e8                	shr    %cl,%eax
  80104f:	09 e8                	or     %ebp,%eax
  801051:	89 44 24 18          	mov    %eax,0x18(%esp)
	      d0 = d0 << bm;
  801055:	8b 44 24 0c          	mov    0xc(%esp),%eax
  801059:	8a 4c 24 10          	mov    0x10(%esp),%cl
  ...
  801065:	d3 e2                	shl    %cl,%edx
	      n0 = n0 << bm;
  801067:	8b 44 24 14          	mov    0x14(%esp),%eax
  80106b:	d3 e0                	shl    %cl,%eax
  80106d:	89 44 24 1c          	mov    %eax,0x1c(%esp)
	      b = W_TYPE_SIZE - bm;
	      ...
	      n2 = n1 >> b;
	      n1 = (n1 << bm) | (n0 >> b);
  801071:	8b 44 24 14          	mov    0x14(%esp),%eax
  801075:	89 f9                	mov    %edi,%ecx
  801077:	d3 e8                	shr    %cl,%eax
  801079:	09 d0                	or     %edx,%eax
	      ...
	      d0 = d0 << bm;
	      n2 = n1 >> b;
  80107b:	d3 ee                	shr    %cl,%esi
	      n1 = (n1 << bm) | (n0 >> b);
	      n0 = n0 << bm;

	      udiv_qrnnd (q0, n1, n2, n1, d1);
  80107d:	89 f2                	mov    %esi,%edx
  80107f:	f7 74 24 18          	divl   0x18(%esp)
  801083:	89 d6                	mov    %edx,%esi
	      umul_ppmm (m1, m0, q0, d0);
  801085:	f7 64 24 0c          	mull   0xc(%esp)
  801089:	89 c5                	mov    %eax,%ebp
  80108b:	89 d1                	mov    %edx,%ecx

	      if (m1 > n1 || (m1 == n1 && m0 > n0))
  80108d:	39 d6                	cmp    %edx,%esi
  80108f:	72 67                	jb     8010f8 <__umoddi3+0x114>
  801091:	74 75                	je     801108 <__umoddi3+0x124>
	      q1 = 0;
  ...
  801093:	8b 44 24 1c          	mov    0x1c(%esp),%eax
  801097:	29 e8                	sub    %ebp,%eax
  801099:	19 ce                	sbb    %ecx,%esi
		  rr.s.low = (n1 << b) | (n0 >> bm);
  ...
  8010ab:	8a 4c 24 10          	mov    0x10(%esp),%cl
  ...
  8010ba:	75 0b                	jne    8010c7 <__umoddi3+0xe3>
	    d0 = 1 / d0;	/* Divide intentionally by zero.  */
  ...
  8010cf:	e9 3e ff ff ff       	jmp    801012 <__umoddi3+0x2e>
	  /* Remainder in n1n0.  */
	  if (rp != 0)
	    {
	      rr.s.low = n0;
  ...
  8010dd:	8d 76 00             	lea    0x0(%esi),%esi
		 ...
		 n1 >= d1 (true due to program flow).  */
	      if (n1 > d1 || n0 >= d0)
  8010e0:	39 f5                	cmp    %esi,%ebp
  8010e2:	72 04                	jb     8010e8 <__umoddi3+0x104>
  8010e4:	39 f9                	cmp    %edi,%ecx
  8010e6:	77 06                	ja     8010ee <__umoddi3+0x10a>
		{
		  q0 = 1;
		  sub_ddmmss (n1, n0, n1, n0, d1, d0);
  8010e8:	89 f2                	mov    %esi,%edx
  8010ea:	29 cf                	sub    %ecx,%edi
  8010ec:	19 ea                	sbb    %ebp,%edx
  ...
  8010fc:	2b 6c 24 0c          	sub    0xc(%esp),%ebp
  801100:	1b 4c 24 18          	sbb    0x18(%esp),%ecx
  801104:	eb 8d                	jmp    801093 <__umoddi3+0xaf>
  801106:	66 90                	xchg   %ax,%ax
	      ...
	      if (m1 > n1 || (m1 == n1 && m0 > n0))
  801108:	39 44 24 1c          	cmp    %eax,0x1c(%esp)
  80110c:	72 ea                	jb     8010f8 <__umoddi3+0x114>
  80110e:	89 f1                	mov    %esi,%ecx
  801110:	eb 81                	jmp    801093 <__umoddi3+0xaf>
