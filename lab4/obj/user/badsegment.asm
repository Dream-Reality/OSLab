...
libmain(int argc, char **argv)
{
  ...
  80004e:	e8 68 0a 00 00       	call   800abb <sys_getenvid>
  ...
  800074:	89 44 24 04          	mov    %eax,0x4(%esp)
	cprintf("%x\n",pthisenv);
  800078:	c7 04 24 c0 0f 80 00 	movl   $0x800fc0,(%esp)
  80007f:	e8 d8 00 00 00       	call   80015c <cprintf>
	// save the name of the program so that panic() can use it
	if (argc > 0)
  800084:	85 f6                	test   %esi,%esi
  800086:	7e 07                	jle    80008f <libmain+0x4f>
		binaryname = argv[0];
	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  80022d:	0f be 80 ce 0f 80 00 	movsbl 0x800fce(%eax),%eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap)
{
  ...
  8003e5:	c7 44 24 08 e6 0f 80 	movl   $0x800fe6,0x8(%esp)
  8003ec:	00 
  ...
  800408:	c7 44 24 08 ef 0f 80 	movl   $0x800fef,0x8(%esp)
  80040f:	00 
  ...
  80043c:	75 05                	jne    800443 <vprintfmt+0x185>
				p = "(null)";
  80043e:	be df 0f 80 00       	mov    $0x800fdf,%esi
			if (width > 0 && padc != '-')
...
sys_env_destroy(envid_t envid)
{
  ...
  800a96:	00 
  800a97:	c7 44 24 08 24 12 80 	movl   $0x801224,0x8(%esp)
  800a9e:	00 
  800a9f:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800aa6:	00 
  800aa7:	c7 04 24 41 12 80 00 	movl   $0x801241,(%esp)
...
sys_page_alloc(envid_t envid, void *va, int perm)
{
  ...
  800b28:	00 
  800b29:	c7 44 24 08 24 12 80 	movl   $0x801224,0x8(%esp)
  800b30:	00 
  800b31:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800b38:	00 
  800b39:	c7 04 24 41 12 80 00 	movl   $0x801241,(%esp)
...
sys_page_map(envid_t srcenv, void *srcva, envid_t dstenv, void *dstva, int perm)
{
  ...
  800b7b:	00 
  800b7c:	c7 44 24 08 24 12 80 	movl   $0x801224,0x8(%esp)
  800b83:	00 
  800b84:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800b8b:	00 
  800b8c:	c7 04 24 41 12 80 00 	movl   $0x801241,(%esp)
...
sys_page_unmap(envid_t envid, void *va)
{
  ...
  800bce:	00 
  800bcf:	c7 44 24 08 24 12 80 	movl   $0x801224,0x8(%esp)
  800bd6:	00 
  800bd7:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800bde:	00 
  800bdf:	c7 04 24 41 12 80 00 	movl   $0x801241,(%esp)
...
sys_env_set_status(envid_t envid, int status)
{
  ...
  800c21:	00 
  800c22:	c7 44 24 08 24 12 80 	movl   $0x801224,0x8(%esp)
  800c29:	00 
  800c2a:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800c31:	00 
  800c32:	c7 04 24 41 12 80 00 	movl   $0x801241,(%esp)
...
sys_env_set_pgfault_upcall(envid_t envid, void *upcall)
{
  ...
  800c74:	00 
  800c75:	c7 44 24 08 24 12 80 	movl   $0x801224,0x8(%esp)
  800c7c:	00 
  800c7d:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800c84:	00 
  800c85:	c7 04 24 41 12 80 00 	movl   $0x801241,(%esp)
...
sys_ipc_recv(void *dstva)
{
  ...
  800ce9:	00 
  800cea:	c7 44 24 08 24 12 80 	movl   $0x801224,0x8(%esp)
  800cf1:	00 
  800cf2:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800cf9:	00 
  800cfa:	c7 04 24 41 12 80 00 	movl   $0x801241,(%esp)
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  800d3c:	c7 04 24 50 12 80 00 	movl   $0x801250,(%esp)
  ...
  800d52:	e8 a4 f3 ff ff       	call   8000fb <vcprintf>
	cprintf("\n");
  800d57:	c7 04 24 c2 0f 80 00 	movl   $0x800fc2,(%esp)
