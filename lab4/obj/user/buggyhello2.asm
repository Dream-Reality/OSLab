...
umain(int argc, char **argv)
{
  ...
  80004a:	e8 f1 09 00 00       	call   800a40 <sys_cputs>
}
  80004f:	c9                   	leave  
  800050:	c3                   	ret    
...
libmain(int argc, char **argv)
{
  ...
  800088:	89 44 24 04          	mov    %eax,0x4(%esp)
	cprintf("%x\n",pthisenv);
  80008c:	c7 04 24 ee 0f 80 00 	movl   $0x800fee,(%esp)
	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  800241:	0f be 80 fc 0f 80 00 	movsbl 0x800ffc(%eax),%eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap)
{
  ...
  80035c:	ff 24 95 c0 10 80 00 	jmp    *0x8010c0(,%edx,4)
  ...
  80041c:	c7 44 24 08 1d 10 80 	movl   $0x80101d,0x8(%esp)
  800423:	00 
  ...
  800450:	75 05                	jne    800457 <vprintfmt+0x185>
				p = "(null)";
  800452:	be 0d 10 80 00       	mov    $0x80100d,%esi
			if (width > 0 && padc != '-')
...
sys_env_destroy(envid_t envid)
{
  ...
  800aaa:	00 
  800aab:	c7 44 24 08 44 12 80 	movl   $0x801244,0x8(%esp)
  800ab2:	00 
  800ab3:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800aba:	00 
  800abb:	c7 04 24 61 12 80 00 	movl   $0x801261,(%esp)
...
sys_page_alloc(envid_t envid, void *va, int perm)
{
  ...
  800b3c:	00 
  800b3d:	c7 44 24 08 44 12 80 	movl   $0x801244,0x8(%esp)
  800b44:	00 
  800b45:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800b4c:	00 
  800b4d:	c7 04 24 61 12 80 00 	movl   $0x801261,(%esp)
...
sys_page_map(envid_t srcenv, void *srcva, envid_t dstenv, void *dstva, int perm)
{
  ...
  800b8f:	00 
  800b90:	c7 44 24 08 44 12 80 	movl   $0x801244,0x8(%esp)
  800b97:	00 
  800b98:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800b9f:	00 
  800ba0:	c7 04 24 61 12 80 00 	movl   $0x801261,(%esp)
...
sys_page_unmap(envid_t envid, void *va)
{
  ...
  800be2:	00 
  800be3:	c7 44 24 08 44 12 80 	movl   $0x801244,0x8(%esp)
  800bea:	00 
  800beb:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800bf2:	00 
  800bf3:	c7 04 24 61 12 80 00 	movl   $0x801261,(%esp)
...
sys_env_set_status(envid_t envid, int status)
{
  ...
  800c35:	00 
  800c36:	c7 44 24 08 44 12 80 	movl   $0x801244,0x8(%esp)
  800c3d:	00 
  800c3e:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800c45:	00 
  800c46:	c7 04 24 61 12 80 00 	movl   $0x801261,(%esp)
...
sys_env_set_pgfault_upcall(envid_t envid, void *upcall)
{
  ...
  800c88:	00 
  800c89:	c7 44 24 08 44 12 80 	movl   $0x801244,0x8(%esp)
  800c90:	00 
  800c91:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800c98:	00 
  800c99:	c7 04 24 61 12 80 00 	movl   $0x801261,(%esp)
...
sys_ipc_recv(void *dstva)
{
  ...
  800cfd:	00 
  800cfe:	c7 44 24 08 44 12 80 	movl   $0x801244,0x8(%esp)
  800d05:	00 
  800d06:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800d0d:	00 
  800d0e:	c7 04 24 61 12 80 00 	movl   $0x801261,(%esp)
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  800d2f:	8b 1d 04 20 80 00    	mov    0x802004,%ebx
  ...
  800d50:	c7 04 24 70 12 80 00 	movl   $0x801270,(%esp)
  ...
  800d66:	e8 a4 f3 ff ff       	call   80010f <vcprintf>
	cprintf("\n");
  800d6b:	c7 04 24 ec 0f 80 00 	movl   $0x800fec,(%esp)
