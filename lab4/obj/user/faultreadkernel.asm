...
libmain(int argc, char **argv)
{
  ...
  800088:	89 44 24 04          	mov    %eax,0x4(%esp)
	cprintf("%x\n",pthisenv);
  80008c:	c7 04 24 07 10 80 00 	movl   $0x801007,(%esp)
	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  800241:	0f be 80 15 10 80 00 	movsbl 0x801015(%eax),%eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap)
{
  ...
  8003f9:	c7 44 24 08 2d 10 80 	movl   $0x80102d,0x8(%esp)
  800400:	00 
  ...
  80041c:	c7 44 24 08 36 10 80 	movl   $0x801036,0x8(%esp)
  800423:	00 
  ...
  800450:	75 05                	jne    800457 <vprintfmt+0x185>
				p = "(null)";
  800452:	be 26 10 80 00       	mov    $0x801026,%esi
			if (width > 0 && padc != '-')
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  800d66:	e8 a4 f3 ff ff       	call   80010f <vcprintf>
	cprintf("\n");
  800d6b:	c7 04 24 09 10 80 00 	movl   $0x801009,(%esp)
