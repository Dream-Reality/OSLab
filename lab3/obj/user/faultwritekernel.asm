...
libmain(int argc, char **argv)
{
  ...
  80004f:	8b 5d 0c             	mov    0xc(%ebp),%ebx
	...
	thisenv = 0;
  800052:	c7 05 04 10 80 00 00 	movl   $0x0,0x801004
  800059:	00 00 00 
	thisenv = envs + ENVX(sys_getenvid());
  80005c:	e8 de 00 00 00       	call   80013f <sys_getenvid>
  800061:	25 ff 03 00 00       	and    $0x3ff,%eax
  800066:	8d 04 40             	lea    (%eax,%eax,2),%eax
  800069:	c1 e0 05             	shl    $0x5,%eax
  80006c:	05 00 00 c0 ee       	add    $0xeec00000,%eax
  800071:	a3 04 10 80 00       	mov    %eax,0x801004
	// save the name of the program so that panic() can use it
	if (argc > 0)
  800076:	85 f6                	test   %esi,%esi
  800078:	7e 07                	jle    800081 <libmain+0x3d>
		binaryname = argv[0];
  ...
  80007c:	a3 00 10 80 00       	mov    %eax,0x801000
	...
	umain(argc, argv);
  800081:	89 5c 24 04          	mov    %ebx,0x4(%esp)
  800085:	89 34 24             	mov    %esi,(%esp)
