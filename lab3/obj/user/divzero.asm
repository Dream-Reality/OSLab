...
umain(int argc, char **argv)
{
  ...
  800055:	c7 04 24 98 0d 80 00 	movl   $0x800d98,(%esp)
  80005c:	e8 0f 01 00 00       	call   800170 <cprintf>
}
  800061:	c9                   	leave  
  800062:	c3                   	ret    
	...
...
libmain(int argc, char **argv)
{
  ...
  80006f:	8b 5d 0c             	mov    0xc(%ebp),%ebx
	...
	thisenv = 0;
  800072:	c7 05 08 20 80 00 00 	movl   $0x0,0x802008
  800079:	00 00 00 
	thisenv = envs + ENVX(sys_getenvid());
  80007c:	e8 4e 0a 00 00       	call   800acf <sys_getenvid>
  ...
  800091:	a3 08 20 80 00       	mov    %eax,0x802008
	// save the name of the program so that panic() can use it
	if (argc > 0)
  800096:	85 f6                	test   %esi,%esi
  800098:	7e 07                	jle    8000a1 <libmain+0x3d>
		binaryname = argv[0];
  ...
  80009c:	a3 00 20 80 00       	mov    %eax,0x802000
	...
	umain(argc, argv);
  8000a1:	89 5c 24 04          	mov    %ebx,0x4(%esp)
  8000a5:	89 34 24             	mov    %esi,(%esp)
  8000a8:	e8 87 ff ff ff       	call   800034 <umain>

	// exit gracefully
	exit();
  8000ad:	e8 0a 00 00 00       	call   8000bc <exit>
}
	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  8001e5:	e8 5e 09 00 00       	call   800b48 <__udivdi3>
  ...
  800238:	e8 2b 0a 00 00       	call   800c68 <__umoddi3>
  80023d:	89 7c 24 04          	mov    %edi,0x4(%esp)
  800241:	0f be 80 b0 0d 80 00 	movsbl 0x800db0(%eax),%eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap)
{
  ...
  80035c:	ff 24 95 40 0e 80 00 	jmp    *0x800e40(,%edx,4)
  ...
  80041c:	c7 44 24 08 d1 0d 80 	movl   $0x800dd1,0x8(%esp)
  800423:	00 
  ...
  800450:	75 05                	jne    800457 <vprintfmt+0x185>
				p = "(null)";
  800452:	be c1 0d 80 00       	mov    $0x800dc1,%esi
			if (width > 0 && padc != '-')
...
sys_env_destroy(envid_t envid)
{
  ...
  800aaa:	00 
  800aab:	c7 44 24 08 b4 0f 80 	movl   $0x800fb4,0x8(%esp)
  800ab2:	00 
  800ab3:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800aba:	00 
  800abb:	c7 04 24 d1 0f 80 00 	movl   $0x800fd1,(%esp)
  800ac2:	e8 29 00 00 00       	call   800af0 <_panic>
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  800af5:	83 ec 20             	sub    $0x20,%esp
	...
	va_start(ap, fmt);
  800af8:	8d 75 14             	lea    0x14(%ebp),%esi

	// Print the panic message
	cprintf("[%08x] user panic in %s at %s:%d: ",
  800afb:	8b 1d 00 20 80 00    	mov    0x802000,%ebx
  800b01:	e8 c9 ff ff ff       	call   800acf <sys_getenvid>
  800b06:	8b 55 0c             	mov    0xc(%ebp),%edx
  800b09:	89 54 24 10          	mov    %edx,0x10(%esp)
  800b0d:	8b 55 08             	mov    0x8(%ebp),%edx
  800b10:	89 54 24 0c          	mov    %edx,0xc(%esp)
  800b14:	89 5c 24 08          	mov    %ebx,0x8(%esp)
  800b18:	89 44 24 04          	mov    %eax,0x4(%esp)
  800b1c:	c7 04 24 e0 0f 80 00 	movl   $0x800fe0,(%esp)
  800b23:	e8 48 f6 ff ff       	call   800170 <cprintf>
		sys_getenvid(), binaryname, file, line);
	vcprintf(fmt, ap);
  800b28:	89 74 24 04          	mov    %esi,0x4(%esp)
  800b2c:	8b 45 10             	mov    0x10(%ebp),%eax
  800b2f:	89 04 24             	mov    %eax,(%esp)
  800b32:	e8 d8 f5 ff ff       	call   80010f <vcprintf>
	cprintf("\n");
  800b37:	c7 04 24 a4 0d 80 00 	movl   $0x800da4,(%esp)
  800b3e:	e8 2d f6 ff ff       	call   800170 <cprintf>

	// Cause a breakpoint exception
	while (1)
		asm volatile("int3");
  800b43:	cc                   	int3   
  800b44:	eb fd                	jmp    800b43 <_panic+0x53>
	...
...
__udivdi3 (UDWtype n, UDWtype d)
{
  ...
  800b4e:	8b 74 24 20          	mov    0x20(%esp),%esi
  800b52:	8b 4c 24 28          	mov    0x28(%esp),%ecx
...
__udivmoddi4 (UDWtype n, UDWtype d, UDWtype *rp)
{
  ...
  800b5a:	8b 7c 24 24          	mov    0x24(%esp),%edi
  const DWunion dd = {.ll = d};
  800b5e:	89 cd                	mov    %ecx,%ebp
  800b60:	8b 44 24 2c          	mov    0x2c(%esp),%eax
  d1 = dd.s.high;
  n0 = nn.s.low;
  n1 = nn.s.high;
  ...
  800b66:	75 2c                	jne    800b94 <__udivdi3+0x4c>
    {
      if (d0 > n1)
  800b68:	39 f9                	cmp    %edi,%ecx
  800b6a:	77 68                	ja     800bd4 <__udivdi3+0x8c>
	}
      else
	{
	  /* qq = NN / 0d */
  ...
  800b6e:	75 0b                	jne    800b7b <__udivdi3+0x33>
...
__udivdi3 (UDWtype n, UDWtype d)
{
  ...
  800b96:	77 2c                	ja     800bc4 <__udivdi3+0x7c>
	}
      else
	{
	  /* 0q = NN / dd */
  ...
  800b98:	0f bd f0             	bsr    %eax,%esi
	  if (bm == 0)
  800b9b:	83 f6 1f             	xor    $0x1f,%esi
  800b9e:	75 4c                	jne    800bec <__udivdi3+0xa4>
  ...
  800ba2:	bf 00 00 00 00       	mov    $0x0,%edi
		 ...
		 n1 >= d1 (true due to program flow).  */
	      if (n1 > d1 || n0 >= d0)
  800ba7:	72 0a                	jb     800bb3 <__udivdi3+0x6b>
  800ba9:	3b 4c 24 04          	cmp    0x4(%esp),%ecx
  800bad:	0f 87 ad 00 00 00    	ja     800c60 <__udivdi3+0x118>
		{
		  q0 = 1;
		  sub_ddmmss (n1, n0, n1, n0, d1, d0);
  800bb3:	be 01 00 00 00       	mov    $0x1,%esi
		}
	    }
	}
    }
...
__udivdi3 (UDWtype n, UDWtype d)
{
  ...
  800be9:	8d 76 00             	lea    0x0(%esi),%esi
	      ...
	      d1 = (d1 << bm) | (d0 >> b);
  800bec:	89 f1                	mov    %esi,%ecx
  800bee:	d3 e0                	shl    %cl,%eax
  800bf0:	89 44 24 0c          	mov    %eax,0xc(%esp)
	  else
	    {
	      UWtype m1, m0;
	      /* Normalize.  */
	      ...
	      b = W_TYPE_SIZE - bm;
  800bf4:	b8 20 00 00 00       	mov    $0x20,%eax
  800bf9:	29 f0                	sub    %esi,%eax

	      d1 = (d1 << bm) | (d0 >> b);
  800bfb:	89 ea                	mov    %ebp,%edx
  800bfd:	88 c1                	mov    %al,%cl
  800bff:	d3 ea                	shr    %cl,%edx
  800c01:	8b 4c 24 0c          	mov    0xc(%esp),%ecx
  800c05:	09 ca                	or     %ecx,%edx
  800c07:	89 54 24 08          	mov    %edx,0x8(%esp)
	      d0 = d0 << bm;
  800c0b:	89 f1                	mov    %esi,%ecx
  800c0d:	d3 e5                	shl    %cl,%ebp
  800c0f:	89 6c 24 0c          	mov    %ebp,0xc(%esp)
	      n2 = n1 >> b;
  800c13:	89 fd                	mov    %edi,%ebp
  800c15:	88 c1                	mov    %al,%cl
  800c17:	d3 ed                	shr    %cl,%ebp
	      n1 = (n1 << bm) | (n0 >> b);
  800c19:	89 fa                	mov    %edi,%edx
  800c1b:	89 f1                	mov    %esi,%ecx
  800c1d:	d3 e2                	shl    %cl,%edx
  800c1f:	8b 7c 24 04          	mov    0x4(%esp),%edi
  800c23:	88 c1                	mov    %al,%cl
  800c25:	d3 ef                	shr    %cl,%edi
  800c27:	09 d7                	or     %edx,%edi
	      n0 = n0 << bm;

	      udiv_qrnnd (q0, n1, n2, n1, d1);
  800c29:	89 f8                	mov    %edi,%eax
  800c2b:	89 ea                	mov    %ebp,%edx
  800c2d:	f7 74 24 08          	divl   0x8(%esp)
  800c31:	89 d1                	mov    %edx,%ecx
  800c33:	89 c7                	mov    %eax,%edi
	      umul_ppmm (m1, m0, q0, d0);
  800c35:	f7 64 24 0c          	mull   0xc(%esp)

	      if (m1 > n1 || (m1 == n1 && m0 > n0))
  800c39:	39 d1                	cmp    %edx,%ecx
  800c3b:	72 17                	jb     800c54 <__udivdi3+0x10c>
  800c3d:	74 09                	je     800c48 <__udivdi3+0x100>
  800c3f:	89 fe                	mov    %edi,%esi
  800c41:	31 ff                	xor    %edi,%edi
  800c43:	e9 41 ff ff ff       	jmp    800b89 <__udivdi3+0x41>
  ...
  800c52:	73 eb                	jae    800c3f <__udivdi3+0xf7>
		{
		  q0--;
  800c54:	8d 77 ff             	lea    -0x1(%edi),%esi
		  sub_ddmmss (m1, m0, m1, m0, d1, d0);
  800c57:	31 ff                	xor    %edi,%edi
  800c59:	e9 2b ff ff ff       	jmp    800b89 <__udivdi3+0x41>
  ...
  800c62:	e9 22 ff ff ff       	jmp    800b89 <__udivdi3+0x41>
	...
...
__umoddi3 (UDWtype u, UDWtype v)
{
  ...
  800c6e:	8b 44 24 30          	mov    0x30(%esp),%eax
  800c72:	8b 4c 24 38          	mov    0x38(%esp),%ecx
static inline __attribute__ ((__always_inline__))
#endif
UDWtype
__udivmoddi4 (UDWtype n, UDWtype d, UDWtype *rp)
{
  const DWunion nn = {.ll = n};
  800c76:	89 44 24 14          	mov    %eax,0x14(%esp)
  800c7a:	8b 74 24 34          	mov    0x34(%esp),%esi
  const DWunion dd = {.ll = d};
  800c7e:	89 4c 24 0c          	mov    %ecx,0xc(%esp)
  800c82:	8b 6c 24 3c          	mov    0x3c(%esp),%ebp
  UWtype q0, q1;
  UWtype b, bm;
...
#if !UDIV_NEEDS_NORMALIZATION
  if (d1 == 0)
  800c8a:	85 ed                	test   %ebp,%ebp
  800c8c:	75 16                	jne    800ca4 <__umoddi3+0x3c>
    {
      if (d0 > n1)
  800c8e:	39 f1                	cmp    %esi,%ecx
  800c90:	0f 86 a6 00 00 00    	jbe    800d3c <__umoddi3+0xd4>
  ...
  800ca3:	90                   	nop
    ...
    {
      if (d1 > n1)
  800ca4:	39 f5                	cmp    %esi,%ebp
  800ca6:	0f 87 ac 00 00 00    	ja     800d58 <__umoddi3+0xf0>
	}
      else
	{
	  /* 0q = NN / dd */
	  ...
	  count_leading_zeros (bm, d1);
  800cac:	0f bd c5             	bsr    %ebp,%eax
	  if (bm == 0)
  800caf:	83 f0 1f             	xor    $0x1f,%eax
  800cb2:	89 44 24 10          	mov    %eax,0x10(%esp)
  800cb6:	0f 84 a8 00 00 00    	je     800d64 <__umoddi3+0xfc>
	      UWtype m1, m0;
	      /* Normalize.  */
	      ...
	      d1 = (d1 << bm) | (d0 >> b);
  800cbc:	8a 4c 24 10          	mov    0x10(%esp),%cl
  800cc0:	d3 e5                	shl    %cl,%ebp
	  else
	    {
	      UWtype m1, m0;
	      /* Normalize.  */
  ...
  800cc7:	2b 7c 24 10          	sub    0x10(%esp),%edi

	      d1 = (d1 << bm) | (d0 >> b);
  800ccb:	8b 44 24 0c          	mov    0xc(%esp),%eax
  800ccf:	89 f9                	mov    %edi,%ecx
  800cd1:	d3 e8                	shr    %cl,%eax
  800cd3:	09 e8                	or     %ebp,%eax
  800cd5:	89 44 24 18          	mov    %eax,0x18(%esp)
	      d0 = d0 << bm;
  800cd9:	8b 44 24 0c          	mov    0xc(%esp),%eax
  800cdd:	8a 4c 24 10          	mov    0x10(%esp),%cl
  800ce1:	d3 e0                	shl    %cl,%eax
  800ce3:	89 44 24 0c          	mov    %eax,0xc(%esp)
	      n2 = n1 >> b;
	      n1 = (n1 << bm) | (n0 >> b);
  800ce7:	89 f2                	mov    %esi,%edx
  800ce9:	d3 e2                	shl    %cl,%edx
	      n0 = n0 << bm;
  800ceb:	8b 44 24 14          	mov    0x14(%esp),%eax
  800cef:	d3 e0                	shl    %cl,%eax
  800cf1:	89 44 24 1c          	mov    %eax,0x1c(%esp)
	      b = W_TYPE_SIZE - bm;
	      ...
	      n2 = n1 >> b;
	      n1 = (n1 << bm) | (n0 >> b);
  800cf5:	8b 44 24 14          	mov    0x14(%esp),%eax
  800cf9:	89 f9                	mov    %edi,%ecx
  800cfb:	d3 e8                	shr    %cl,%eax
  800cfd:	09 d0                	or     %edx,%eax
  ...
  800d03:	f7 74 24 18          	divl   0x18(%esp)
  800d07:	89 d6                	mov    %edx,%esi
	      umul_ppmm (m1, m0, q0, d0);
  800d09:	f7 64 24 0c          	mull   0xc(%esp)
  800d0d:	89 c5                	mov    %eax,%ebp
  800d0f:	89 d1                	mov    %edx,%ecx

	      if (m1 > n1 || (m1 == n1 && m0 > n0))
  800d11:	39 d6                	cmp    %edx,%esi
  800d13:	72 67                	jb     800d7c <__umoddi3+0x114>
  800d15:	74 75                	je     800d8c <__umoddi3+0x124>
	      q1 = 0;
  ...
  800d17:	8b 44 24 1c          	mov    0x1c(%esp),%eax
  800d1b:	29 e8                	sub    %ebp,%eax
  800d1d:	19 ce                	sbb    %ecx,%esi
		  rr.s.low = (n1 << b) | (n0 >> bm);
  ...
  800d2f:	8a 4c 24 10          	mov    0x10(%esp),%cl
  ...
  800d3e:	75 0b                	jne    800d4b <__umoddi3+0xe3>
	    d0 = 1 / d0;	/* Divide intentionally by zero.  */
  ...
  800d53:	e9 3e ff ff ff       	jmp    800c96 <__umoddi3+0x2e>
	  /* Remainder in n1n0.  */
	  if (rp != 0)
	    {
	      rr.s.low = n0;
  ...
  800d61:	8d 76 00             	lea    0x0(%esi),%esi
		 ...
		 n1 >= d1 (true due to program flow).  */
	      if (n1 > d1 || n0 >= d0)
  800d64:	39 f5                	cmp    %esi,%ebp
  800d66:	72 04                	jb     800d6c <__umoddi3+0x104>
  800d68:	39 f9                	cmp    %edi,%ecx
  800d6a:	77 06                	ja     800d72 <__umoddi3+0x10a>
		{
		  q0 = 1;
		  sub_ddmmss (n1, n0, n1, n0, d1, d0);
  800d6c:	89 f2                	mov    %esi,%edx
  800d6e:	29 cf                	sub    %ecx,%edi
  800d70:	19 ea                	sbb    %ebp,%edx
  ...
  800d7e:	89 c5                	mov    %eax,%ebp
  800d80:	2b 6c 24 0c          	sub    0xc(%esp),%ebp
  800d84:	1b 4c 24 18          	sbb    0x18(%esp),%ecx
  800d88:	eb 8d                	jmp    800d17 <__umoddi3+0xaf>
  800d8a:	66 90                	xchg   %ax,%ax
	      ...
	      if (m1 > n1 || (m1 == n1 && m0 > n0))
  800d8c:	39 44 24 1c          	cmp    %eax,0x1c(%esp)
  800d90:	72 ea                	jb     800d7c <__umoddi3+0x114>
  800d92:	89 f1                	mov    %esi,%ecx
  800d94:	eb 81                	jmp    800d17 <__umoddi3+0xaf>
