...
umain(int argc, char **argv)
{
  ...
  800043:	c7 04 24 88 0d 80 00 	movl   $0x800d88,(%esp)
  80004a:	e8 11 01 00 00       	call   800160 <cprintf>
}
  80004f:	c9                   	leave  
  800050:	c3                   	ret    
...
libmain(int argc, char **argv)
{
  ...
  80006c:	e8 4e 0a 00 00       	call   800abf <sys_getenvid>
	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  800231:	0f be 80 b9 0d 80 00 	movsbl 0x800db9(%eax),%eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap)
{
  ...
  80034c:	ff 24 95 48 0e 80 00 	jmp    *0x800e48(,%edx,4)
  ...
  80040c:	c7 44 24 08 da 0d 80 	movl   $0x800dda,0x8(%esp)
  800413:	00 
  ...
  800440:	75 05                	jne    800447 <vprintfmt+0x185>
				p = "(null)";
  800442:	be ca 0d 80 00       	mov    $0x800dca,%esi
			if (width > 0 && padc != '-')
...
sys_env_destroy(envid_t envid)
{
  ...
  800a9a:	00 
  800a9b:	c7 44 24 08 bc 0f 80 	movl   $0x800fbc,0x8(%esp)
  800aa2:	00 
  800aa3:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800aaa:	00 
  800aab:	c7 04 24 d9 0f 80 00 	movl   $0x800fd9,(%esp)
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  800b0c:	c7 04 24 e8 0f 80 00 	movl   $0x800fe8,(%esp)
  ...
  800b22:	e8 d8 f5 ff ff       	call   8000ff <vcprintf>
	cprintf("\n");
  800b27:	c7 04 24 0c 10 80 00 	movl   $0x80100c,(%esp)
