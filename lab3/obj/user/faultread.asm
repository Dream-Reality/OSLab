	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  800231:	0f be 80 b0 0d 80 00 	movsbl 0x800db0(%eax),%eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap)
{
  ...
  80034c:	ff 24 95 40 0e 80 00 	jmp    *0x800e40(,%edx,4)
  ...
  80040c:	c7 44 24 08 d1 0d 80 	movl   $0x800dd1,0x8(%esp)
  800413:	00 
  ...
  800440:	75 05                	jne    800447 <vprintfmt+0x185>
				p = "(null)";
  800442:	be c1 0d 80 00       	mov    $0x800dc1,%esi
			if (width > 0 && padc != '-')
...
sys_env_destroy(envid_t envid)
{
  ...
  800a9a:	00 
  800a9b:	c7 44 24 08 b4 0f 80 	movl   $0x800fb4,0x8(%esp)
  800aa2:	00 
  800aa3:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800aaa:	00 
  800aab:	c7 04 24 d1 0f 80 00 	movl   $0x800fd1,(%esp)
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  800b0c:	c7 04 24 e0 0f 80 00 	movl   $0x800fe0,(%esp)
  ...
  800b22:	e8 d8 f5 ff ff       	call   8000ff <vcprintf>
	cprintf("\n");
  800b27:	c7 04 24 a4 0d 80 00 	movl   $0x800da4,(%esp)
